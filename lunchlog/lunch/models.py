...
class Restaurant(Address):
    ...
    serves_beer = models.BooleanField(default=False, null=True, blank=True)
    serves_breakfast = models.BooleanField(default=False, null=True, blank=True)
    serves_brunch = models.BooleanField(default=False, null=True, blank=True)
    serves_dinner = models.BooleanField(default=False, null=True, blank=True)
    serves_lunch = models.BooleanField(default=False, null=True, blank=True)
    serves_vegetarian_food = models.BooleanField(default=False, null=True, blank=True)
    serves_wine = models.BooleanField(default=False, null=True, blank=True)
    takeout = models.BooleanField(default=False, null=True, blank=True)
